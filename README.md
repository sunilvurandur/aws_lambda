...
### AWS Lambda Setup
#### Created a new Lambda function with the following settings:
...
#### Creating the following resources and methods:
...
#### Making sure Integration Type is `Lambda Function`
...
### Deleting Student Record (DELETE)
```bash
  curl -X DELETE \
    https://n9rtotemdl.execute-api.us-east-2.amazonaws.com/dev/students \
    -H 'Content-Type: application/json' \
